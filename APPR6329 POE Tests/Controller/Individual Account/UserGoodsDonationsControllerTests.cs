...
{
    public class UserGoodsDonationsControllerTests: IDisposable
    {
        private ApplicationDbContext _context;
        private UserGoodsDonationsController _userGoodsDonationsController;
        public UserGoodsDonationsControllerTests()
        {
            ...
            _userGoodsDonationsController = new UserGoodsDonationsController(_context, userManager);
        }
        public void Dispose()
        {
        ...
        public async Task Create_Post_ReturnsViewWithInvalid_GoodsDonationModel()
        {
            ...
            // Act
            var result = await _userGoodsDonationsController.Create(invalidGoodsDonation);
        ...
        public async Task Create_RedirectsToIndexWithValid_GoodsDonationModel()
        {
            ...
            // Act
            var result = await _userGoodsDonationsController.Create(validGoodsDonation);
